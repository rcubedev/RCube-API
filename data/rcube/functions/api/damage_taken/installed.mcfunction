...
# Store version
data modify storage rcube:api/damage_taken root.version.this.str set value "0.13.0"
data modify storage rcube:api/damage_taken root.version.this.major set value 0
data modify storage rcube:api/damage_taken root.version.this.minor set value 13
