...
execute if data storage rcube:api/centre_string root{private:{load_message:true},installed:true} run tellraw @a ["",{"text": "[","color": "dark_gray"},{"text": "RCube API","color": "gray"},{"text": "] ","color": "dark_gray"},{"text": "Module ","color" :"gray"},{"text": "'","color": "green"},{"text": "centre_string", "color":"green"},{"text": "' ","color": "green"},{"text": "reloaded.","color": "gray"}]
execute if data storage rcube:api/centre_string root{private:{load_message:true}} unless data storage rcube:api/centre_string root{installed:true} run tellraw @a ["",{"text": "[","color": "dark_gray"},{"text": "RCube API","color": "gray"},{"text": "] ","color": "dark_gray"},{"text": "Module ","color" :"gray"},{"text": "'","color": "red"},{"text": "centre_string", "color":"red"},{"text": "' ","color": "red"},{"text": "is missing dependencies.\n","color": "gray"},{"text": "[","color": "dark_gray"},{"text": "RCube API","color": "gray"},{"text": "] Missing Dependencies:\n","color": "dark_gray"},{"nbt":"root.private.dependencies[].missing","storage":"rcube:api/centre_string","interpret":true,"separator":"\n"},"\n"]
