...
# Store version
data modify storage rcube:api/damage_dealt root.version.this.str set value "0.3.0"
data modify storage rcube:api/damage_dealt root.version.this.major set value 0
data modify storage rcube:api/damage_dealt root.version.this.minor set value 3
data modify storage rcube:api/damage_dealt root.version.this.patch set value 0

# Store game version
data modify storage rcube:api/damage_dealt root.version.game.str set value "1.20.2"
