...
# Store UUID of mob attacked and set to attacker
...
# Reset total damage if player attacked other
...
execute if entity @s[tag=damage_dealt.damage.total] on attacker if entity @s[tag=damage_dealt.player.attacked_other.temp] run scoreboard players reset @s rcubeAPI_damageDealt.damage.total
execute if entity @s[tag=damage_dealt.damage.total] on attacker if entity @s[tag=damage_dealt.player.attacked_other.temp] run tag @s remove damage_dealt.player.attacked_other.temp
