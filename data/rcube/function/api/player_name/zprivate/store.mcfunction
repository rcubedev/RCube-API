...
execute in rcube:api/core/commands run data modify storage rcube:api/player_name root.private.temp.profile set from block 0 0 0 Items[{Slot:0b}].tag.profile
