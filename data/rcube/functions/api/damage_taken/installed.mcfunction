...
# Store version
data modify storage rcube:api/damage_taken root.version.this.str set value "0.16.0"
data modify storage rcube:api/damage_taken root.version.this.major set value 0
data modify storage rcube:api/damage_taken root.version.this.minor set value 16
data modify storage rcube:api/damage_taken root.version.this.patch set value 0

# Store game version
data modify storage rcube:api/damage_taken root.version.game.str set value "1.20.5"
data modify storage rcube:api/damage_taken root.version.game.major set value 20
data modify storage rcube:api/damage_taken root.version.game.patch set value 5
