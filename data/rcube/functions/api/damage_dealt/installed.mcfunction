...
# Store version
data modify storage rcube:api/damage_dealt root.version.this.str set value "0.12.0"
data modify storage rcube:api/damage_dealt root.version.this.major set value 0
data modify storage rcube:api/damage_dealt root.version.this.minor set value 12
