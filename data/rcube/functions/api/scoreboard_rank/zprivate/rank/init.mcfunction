...
execute as @e[scores={rcube_api.scoreboard_rank.temp=-2147483648..2147483647}] if score @s rcube_api.scoreboard_rank.temp = #highest rcube_api.scoreboard_rank.temp run function rcube:api/scoreboard_rank/zprivate/rank/assign

# If entities on the temporary scoreboard, loop
execute if entity @e[scores={rcube_api.scoreboard_rank.temp=-2147483648..2147483647}] run function rcube:api/scoreboard_rank/zprivate/rank/init
