...
execute if data storage rcube:api/centre_string {private:{temp:{extra:{chars:true}}}} unless data storage rcube:api/centre_string {private:{temp:{extra:{bold:true}}}} run scoreboard players operation $char_count rcubeAPI-centre_string += $input.char_count.extra rcubeAPI-centre_string
...
execute if data storage rcube:api/centre_string {private:{temp:{chars:true}}} run scoreboard players operation $px.extra rcubeAPI-centre_string = $input.char_count.extra rcubeAPI-centre_string
...
execute if data storage rcube:api/centre_string {private:{temp:{extra:{chars:true,bold:true}}}} run scoreboard players operation $px.extra rcubeAPI-centre_string += $input.char_count.extra rcubeAPI-centre_string
...
execute if data storage rcube:api/centre_string {private:{temp:{extra:{px:true}}}} run scoreboard players operation $px rcubeAPI-centre_string += $input.px.extra rcubeAPI-centre_string
