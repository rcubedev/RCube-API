...
# Set state
execute if predicate rcube:api/_core/installed if data storage rcube:api/core root{installed:true} if score $ver.core.major rcubeAPI_playerName.deps matches 0 if score $ver.core.minor rcubeAPI_playerName.deps matches 7 if score $ver.core.patch rcubeAPI_playerName.deps matches 0 if score $ver.core.game.major rcubeAPI_playerName.deps matches 20 if score $ver.core.game.patch rcubeAPI_playerName.deps matches 1 run data modify storage rcube:api/player_name root.private.dependencies append value {module:"core",installed:true}
