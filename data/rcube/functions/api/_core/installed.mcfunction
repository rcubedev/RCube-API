...
# Store version
data modify storage rcube:api/core root.version.this.str set value "0.9.0"
data modify storage rcube:api/core root.version.this.major set value 0
data modify storage rcube:api/core root.version.this.minor set value 9
data modify storage rcube:api/core root.version.this.patch set value 0

# Store game version
data modify storage rcube:api/core root.version.game.str set value "1.20.4"
data modify storage rcube:api/core root.version.game.major set value 20
data modify storage rcube:api/core root.version.game.patch set value 4
