...
# Store version
data modify storage rcube:api/scoreboard_rank root.version.this.str set value "0.11.0"
data modify storage rcube:api/scoreboard_rank root.version.this.major set value 0
data modify storage rcube:api/scoreboard_rank root.version.this.minor set value 11
data modify storage rcube:api/scoreboard_rank root.version.this.patch set value 0

# Store game version
data modify storage rcube:api/scoreboard_rank root.version.game.str set value "1.21.2"
data modify storage rcube:api/scoreboard_rank root.version.game.major set value 21
