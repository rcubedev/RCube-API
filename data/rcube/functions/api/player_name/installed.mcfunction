...
# Store version
data modify storage rcube:api/player_name root.version.this.str set value "0.15.2"
...
data modify storage rcube:api/player_name root.version.this.patch set value 2
