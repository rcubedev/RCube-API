...
# Store version
data modify storage rcube:api/centre_string root.version.this.str set value "0.16.2"
...
data modify storage rcube:api/centre_string root.version.this.patch set value 2
