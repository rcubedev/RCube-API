...
execute unless entity @e[scores={rcubeAPI_scoreboard_rank.temp=-2147483648..2147483647}] run data modify storage rcube:api/scoreboard_rank out.done set value true