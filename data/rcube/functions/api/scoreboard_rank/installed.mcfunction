...
data modify storage rcube:api/scoreboard_rank root.version.this.minor set value 10
data modify storage rcube:api/scoreboard_rank root.version.this.patch set value 0

# Store game version
data modify storage rcube:api/scoreboard_rank root.version.game.str set value "1.20.5"
data modify storage rcube:api/scoreboard_rank root.version.game.major set value 20
data modify storage rcube:api/scoreboard_rank root.version.game.patch set value 5
