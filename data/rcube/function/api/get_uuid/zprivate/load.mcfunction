...
execute if data storage rcube:api/get_uuid root{private:{load_message:true},installed:true} run tellraw @a ["",{"text": "[","color": "dark_gray"},{"text": "RCube API","color": "gray"},{"text": "] ","color": "dark_gray"},{"text": "Module ","color" :"gray"},{"text": "'","color": "green"},{"text": "get_uuid", "color":"green"},{"text": "' ","color": "green"},{"text": "reloaded.\n               ","color": "gray"},{"text": "\u200c\u200c","color": "gray","bold": true},{"text": "Credit to gibbsly (gibbsly/gu)","color": "gray"}]
execute if data storage rcube:api/get_uuid root{private:{load_message:true}} unless data storage rcube:api/get_uuid root{installed:true} run tellraw @a ["",{"text": "[","color": "dark_gray"},{"text": "RCube API","color": "gray"},{"text": "] ","color": "dark_gray"},{"text": "Module ","color" :"gray"},{"text": "'","color": "red"},{"text": "get_uuid", "color":"red"},{"text": "' ","color": "red"},{"text": "failed to load.","color": "gray"}]
